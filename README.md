...
we can also do a 3d watershed, **mark the up and down as two mark**, then **watershed on the 3d gradient image**. we can get a perfect marsk. Then do a 3d surface reconstruction with **vtk(mayavi)**.
